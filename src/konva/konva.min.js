!(function (t, e) {
  ...
  var d = (function () {
    ...
    I = {
      ...
      colorToRGBA: function (t) {
        return (
          (t = t || "black"),
          I._namedColorToRBA(t) ||
            I._hex3ColorToRGBA(t) ||
            I._hex6ColorToRGBA(t) ||
            I._rgbColorToRGBA(t) ||
            I._rgbaColorToRGBA(t) ||
            I._hslColorToRGBA(t)
        );
      },
      ...
      _hslColorToRGBA: function (t) {
        if (/hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.test(t)) {
          ...
          for (
            var l = 2 * o - (a = o < 0.5 ? o * (1 + r) : o + r - o * r),
              d = [0, 0, 0],
              c = 0;
            c < 3;
            c++
      ...
      _prepareArrayForTween: function (t, e, i) {
        ...
        for (n = 0; n < t.length; n += 2) r.push({ x: t[n], y: t[n + 1] });
        for (n = 0; n < e.length; n += 2) o.push({ x: e[n], y: e[n + 1] });
        var s = [];
        return (
        ...
        for (var i in ((t.visitedByCircularReferenceRemoval = !0), t))
          if (t.hasOwnProperty(i) && t[i] && "object" == typeof t[i])
            if (
              ...
              t[i].visitedByCircularReferenceRemoval || I._isElement(t[i]))
            ) {
    ...
    b = {
      ...
      addComponentsGetterSetter: function (t, n, e, r, o) {
        ...
        (t.prototype[d] = function (t) {
          var e,
            i = this.attrs[n];
          for (e in (r && (t = r.call(this, t)), c && c.call(this, t, n), t))
    ...
    P = (function () {
      function t(t) {
        (this.canvas = t),
          ...
          O.enableTrace && ((this.traceArr = []), this._enableTrace());
      }
      return (
        ...
        (t.prototype.drawImage = function (t, e, i, n, r, o, a, s, h) {
          ...
          3 === l.length
            ? d.drawImage(t, e, i)
            : 5 === l.length
            ? d.drawImage(t, e, i, n, r)
            : 9 === l.length && d.drawImage(t, e, i, n, r, o, a, s, h);
        }),
  ...
  var A = (function () {
    function t(t) {
      ...
      (this.pixelRatio = e),
        (this._canvas = I.createCanvasElement()),
    ...
    L = {
      ...
      _drag: function (a) {
        L._dragElements.forEach(function (e, t) {
          ...
          n.setPointersPositions(a),
            void 0 === e.pointerId && (e.pointerId = I._getFirstPointerId(a));
          ...
          if (r) {
            ...
            i._setDragPosition(a, e),
              i.fire("dragmove", { type: "dragmove", target: i, evt: a }, !0);
          }
        });
      },
      _endDragBefore: function (r) {
        L._dragElements.forEach(function (e, t) {
          ...
          if (
            (i.setPointersPositions(r),
            i._changedPointerPositions.find(function (t) {
              return t.id === e.pointerId;
            }))
          ) {
            e.isDragging && ((L.justDragged = !0), (O.listenClickTap = !1)),
              (e.dragStopped = !0),
              (e.isDragging = !1);
    ...
    $ = (function () {
      ...
      return (
        ...
        (s.prototype.cache = function (t) {
          ...
          if (n && r) {
            ...
            var d = new G({
              ...
              c = new G({ pixelRatio: o, width: n, height: r }),
              p = new R({ pixelRatio: 1, width: n, height: r }),
              u = d.getContext(),
              f = p.getContext();
            return (
              (p.isCache = !0),
              this._cache.delete("canvas"),
              (this._filterUpToDate = !1) === e.imageSmoothingEnabled &&
              ...
              l &&
                ...
                u.stroke(),
                u.restore()),
              this._cache.set(H, { scene: d, filter: c, hit: p, x: a, y: s }),
              this
            );
          }
          I.error(
        ...
        (s.prototype.on = function (t, e) {
          ...
          for (i = 0; i < s; i++)
            (r = (n = a[i].split("."))[0]),
              ...
              this.eventListeners[r].push({ name: o, handler: e });
          return this;
        }),
        ...
        (s.prototype._delegate = function (t, n, r) {
          ...
          this.on(t, function (t) {
            for (
              ...
              ((t = I.cloneObject(t)).currentTarget = e[i]), r.call(e[i], t);
          });
        }),
        (s.prototype.remove = function () {
          return (
            this.isDragging() && this.stopDrag(),
            L._dragElements.delete(this._id),
            this._remove(),
            this
          );
        }),
        ...
        (s.prototype.setAttrs = function (t) {
          ...
          for (e in t)
            "children" !== e &&
              ((i = "set" + I._capitalize(e)),
              I._isFunction(this[i]) ? this[i](t[e]) : this._setAttr(e, t[e]));
          return this;
        }),
        ...
        (s.prototype.moveToTop = function () {
          if (!this.parent)
            return (
              I.warn("Node has no parent. moveToTop function is ignored."), !1
            );
          var t = this.index;
          return (
        ...
        (s.prototype.moveUp = function () {
          if (!this.parent)
            return (
              I.warn("Node has no parent. moveUp function is ignored."), !1
            );
          var t = this.index;
          return (
        ...
        (s.prototype.moveDown = function () {
          if (!this.parent)
            return (
              I.warn("Node has no parent. moveDown function is ignored."), !1
            );
          var t = this.index;
          return (
            0 < t &&
        ...
        (s.prototype.moveToBottom = function () {
          if (!this.parent)
            return (
              I.warn("Node has no parent. moveToBottom function is ignored."),
              !1
            );
          var t = this.index;
          return (
        ...
        (s.prototype.setZIndex = function (t) {
          if (!this.parent)
            return (
              I.warn("Node has no parent. zIndex parameter is ignored."), this
            );
        ...
        (s.prototype.toObject = function () {
          ...
          for (t in ((n.attrs = {}), r))
            (e = r[t]),
              (I.isObject(e) && !I._isPlainObject(e) && !I._isArray(e)) ||
        ...
        (s.prototype.getAbsoluteScale = function (t) {
          return t
            ...
            : this._getCache(N, this._getAbsoluteScale);
        }),
          ...
          for (e in this.eventListeners)
            for (n = (i = this.eventListeners[e]).length, r = 0; r < n; r++)
              (o = i[r]).name.indexOf("konva") < 0 &&
                (h.eventListeners[e] || (h.eventListeners[e] = []),
        ...
        (s.prototype.toImage = function (t) {
          ...
          var e = t.callback;
          delete t.callback,
            I._urlToImage(this.toDataURL(t), function (t) {
              e(t);
            });
        }),
        ...
        (s.prototype.setName = function (t) {
          var e,
            ...
            n,
            r,
            o = (this.name() || "").split(/\s/g),
            a = (t || "").split(/\s/g);
          for (i = 0; i < o.length; i++)
            (e = o[i]), -1 === a.indexOf(e) && e && B(e, this._id);
          for (i = 0; i < a.length; i++)
            (e = a[i]),
              -1 === o.indexOf(e) &&
                e &&
                ((n = this), (r = e) && (E[r] || (E[r] = []), E[r].push(n)));
        ...
        (s.prototype._fireAndBubble = function (t, e, i) {
          if (
            ...
            !(
              (t === X || t === j) &&
              ((i &&
                (this === i || (this.isAncestorOf && this.isAncestorOf(i)))) ||
        ...
        (s.prototype.startDrag = function (t) {
          ...
          i &&
            L._dragElements.set(this._id, {
              node: this,
              startPointerPos: i,
              offset: { x: i.x - n.x, y: i.y - n.y },
              isDragging: !1,
              pointerId: e,
              dragStopped: !1,
            });
        ...
        (s.prototype.stopDrag = function () {
          var t = {};
          (L._dragElements.get(this._id).dragStopped = !0),
            L._endDragBefore(t),
            L._endDragAfter(t);
        }),
        ...
        (s.prototype._listenDrag = function () {
          this._dragCleanup(),
            this.on("mousedown.konva touchstart.konva", function (t) {
              (!(void 0 !== t.evt.button) ||
                0 <= O.dragButtons.indexOf(t.evt.button)) &&
                (this.isDragging() || this.startDrag(t));
            });
        }),
        ...
        (s._createNode = function (t, e) {
          var i,
            n,
            r,
            o = s.prototype.getClassName.call(t),
            a = t.children;
          if (
  ...
  ($.prototype.nodeType = "Node"),
    ($.prototype._attrsAffectingSize = []),
    b.addGetterSetter($, "zIndex"),
    b.addGetterSetter($, "absolutePosition"),
    b.addGetterSetter($, "position"),
    b.addGetterSetter($, "x", 0, g()),
    b.addGetterSetter($, "y", 0, g()),
    b.addGetterSetter($, "globalCompositeOperation", "source-over", y()),
    b.addGetterSetter($, "opacity", 1, g()),
    b.addGetterSetter($, "name", "", y()),
    b.addGetterSetter($, "id", "", y()),
    b.addGetterSetter($, "rotation", 0, g()),
    b.addComponentsGetterSetter($, "scale", ["x", "y"]),
    b.addGetterSetter($, "scaleX", 1, g()),
    b.addGetterSetter($, "scaleY", 1, g()),
    b.addComponentsGetterSetter($, "skew", ["x", "y"]),
    b.addGetterSetter($, "skewX", 0, g()),
    b.addGetterSetter($, "skewY", 0, g()),
    b.addComponentsGetterSetter($, "offset", ["x", "y"]),
    b.addGetterSetter($, "offsetX", 0, g()),
    b.addGetterSetter($, "offsetY", 0, g()),
    b.addGetterSetter($, "dragDistance", null, g()),
    b.addGetterSetter($, "width", 0, g()),
    b.addGetterSetter($, "height", 0, g()),
    b.addGetterSetter($, "listening", "inherit", function (t) {
      return (
        !0 === t ||
          !1 === t ||
          "inherit" === t ||
    ...
    b.addGetterSetter($, "preventDefault", !0, m()),
    b.addGetterSetter($, "filters", null, function (t) {
    ...
    b.addGetterSetter($, "transformsEnabled", "all", y()),
    b.addGetterSetter($, "size"),
    b.addGetterSetter($, "dragBoundFunc"),
    b.addGetterSetter($, "draggable", !1, m()),
    b.backCompat($, {
      rotateDeg: "rotate",
    ...
    return (
          ...
          (this.isVisible() || i) &&
            (!i && s
              ? (o.save(),
                ...
                o.restore())
              : this._drawChildren(r, "drawScene", e, !1, i, i)),
          this
        );
      }),
      (t.prototype.drawHit = function (t, e, i) {
        var n = this.getLayer(),
          ...
          s = a && a.hit;
        return (
          (this.shouldDrawHit(r) || i) &&
            (!i && s
              ? (o.save(),
                n._applyTransform(this, o, e),
                this._drawCachedHitCanvas(o),
                o.restore())
              : this._drawChildren(r, "drawHit", e, !1, i, i)),
          this
        );
      }),
      (t.prototype._drawChildren = function (e, i, n, r, o, t) {
        ...
        if (u && h) {
          ...
          l.transform(g[0], g[1], g[2], g[3], g[4], g[5]),
            ...
            p
              ? p.call(this, l, this)
              : ((a = this.clipX()), (s = this.clipY()), l.rect(a, s, d, c)),
            l.clip(),
            (g = f.copy().invert().getMatrix()),
            l.transform(g[0], g[1], g[2], g[3], g[4], g[5]);
        }
        var v = "source-over" !== this.globalCompositeOperation() && !t;
        v && h && (l.save(), l._applyGlobalCompositeOperation(this)),
          this.children.each(function (t) {
            t[i](e, n, r, o);
          }),
          v && h && l.restore(),
        ...
        this.children.each(function (t) {
          if (t.visible()) {
            ...
            (0 === e.width && 0 === e.height) ||
              (a =
                void 0 === n
                  ? ((n = e.x), (r = e.y), (o = e.x + e.width), e.y + e.height)
                  : ((n = Math.min(n, e.x)),
                    (r = Math.min(r, e.y)),
  ...
  b.addComponentsGetterSetter(tt, "clip", ["x", "y", "width", "height"]),
    b.addGetterSetter(tt, "clipX", void 0, g()),
    b.addGetterSetter(tt, "clipY", void 0, g()),
    b.addGetterSetter(tt, "clipWidth", void 0, g()),
    b.addGetterSetter(tt, "clipHeight", void 0, g()),
    b.addGetterSetter(tt, "clipFunc"),
    a.mapMethods(tt);
  var et = new Map();
  function it(t) {
    return et.get(t);
  ...
  function ot(t, e) {
    at(t),
      e.getStage() &&
        ...
        e._fire(
          "gotpointercapture",
          nt(new PointerEvent("gotpointercapture"))
        ));
  }
  function at(t, e) {
    var i = et.get(t);
    if (i) {
      ...
      n && n.content,
        ...
        i._fire(
          "lostpointercapture",
          nt(new PointerEvent("lostpointercapture"))
        );
    }
  }
  var st = "mouseout",
    ...
    return (
      ...
      (t.prototype.clone = function (t) {
        return (
          ...
          tt.prototype.clone.call(this, t)
        );
      }),
      (t.prototype.destroy = function () {
      ...
      (t.prototype._resizeDOM = function () {
        if (this.content) {
          ...
          for (
            ...
            (e = r[t]).setSize({ width: i, height: n }), e.draw();
        }
      }),
      (t.prototype.add = function (t) {
        if (1 < arguments.length) {
        ...
        return (
          ...
          t.draw(),
          O.isBrowser && this.content.appendChild(t.canvas._canvas),
          this
        );
      }),
      ...
      (t.prototype._bindContentEvents = function () {
        if (O.isBrowser) for (var t = 0; t < Pt; t++) kt(this, Ct[t]);
      }),
      (t.prototype._mouseenter = function (t) {
        this.setPointersPositions(t),
          this._fire(dt, { evt: t, target: this, currentTarget: this });
      }),
      (t.prototype._mouseover = function (t) {
        this.setPointersPositions(t),
          this._fire("contentMouseover", { evt: t }),
          this._fire(lt, { evt: t, target: this, currentTarget: this });
      }),
      (t.prototype._mouseout = function (t) {
        this.setPointersPositions(t);
        var e = this.targetShape;
        e && !L.isDragging
          ? (e._fireAndBubble(st, { evt: t }),
            e._fireAndBubble(ht, { evt: t }),
            (this.targetShape = null))
          : L.isDragging ||
            (this._fire(ht, { evt: t, target: this, currentTarget: this }),
            this._fire(st, { evt: t, target: this, currentTarget: this })),
          ...
          if (
            ...
            !L.isDragging && n
              ? (this.targetShape &&
                ...
                (this.targetShape = e))
              : e._fireAndBubble(ct, { evt: t, pointerId: i });
          } else
            this.targetShape &&
              !L.isDragging &&
              (this.targetShape._fireAndBubble(st, { evt: t, pointerId: i }),
              this.targetShape._fireAndBubble(ht, { evt: t, pointerId: i }),
              this._fire(lt, {
                evt: t,
                target: this,
                currentTarget: this,
      ...
      (t.prototype._mousedown = function (t) {
        ...
        (O.listenClickTap = !0),
          i && i.isListening()
            ? (this.clickStartShape = i)._fireAndBubble(pt, {
                evt: t,
                pointerId: e,
              })
            : this._fire(pt, {
      ...
      (t.prototype._mouseup = function (t) {
        ...
        O.inDblClickWindow
          ...
          : L.justDragged
          ? L && (L.justDragged = !1)
          : ((O.inDblClickWindow = !0), clearTimeout(this.dblTimeout)),
          (this.dblTimeout = setTimeout(function () {
            O.inDblClickWindow = !1;
          }, O.dblClickWindow)),
          i && i.isListening()
            ? ((this.clickEndShape = i)._fireAndBubble(ut, {
                evt: t,
                pointerId: e,
              }),
              O.listenClickTap &&
                ...
                o &&
                  r &&
                  r === i &&
                  i._fireAndBubble(mt, { evt: t, pointerId: e })))
            : (this._fire(ut, {
                evt: t,
                target: this,
                currentTarget: this,
      ...
      (t.prototype._touchmove = function (i) {
        var n = this;
        if (
          (this.setPointersPositions(i), !L.isDragging || O.hitOnDragEnabled)
        ) {
          var r = !1,
            o = {};
          this._changedPointerPositions.forEach(function (t) {
            ...
            e &&
              ...
              (o[e._id] ||
                ((o[e._id] = !0),
                e._fireAndBubble(bt, { evt: i, pointerId: t.id }),
                (r = !0),
                e.isListening() &&
                  e.preventDefault() &&
                  i.cancelable &&
      ...
      (t.prototype._touchend = function (i) {
        ...
        var r = this.clickEndShape,
          o = !1;
        O.inDblClickWindow ? (o = !0) : (O.inDblClickWindow = !0),
        ...
        this._changedPointerPositions.forEach(function (t) {
          ...
          e && e.releaseCapture(t.id),
            e &&
              ...
              (s[e._id] ||
                ((s[e._id] = !0),
                (n.clickEndShape = e)._fireAndBubble(St, {
                  evt: i,
                  pointerId: t.id,
                }),
                (a = !0),
                O.listenClickTap &&
                  n.tapStartShape &&
                  e._id === n.tapStartShape._id &&
                  (e._fireAndBubble("tap", { evt: i, pointerId: t.id }),
                  o &&
                    r &&
                    r === e &&
                    e._fireAndBubble("dbltap", { evt: i, pointerId: t.id })),
                e.isListening() &&
                  e.preventDefault() &&
                  i.cancelable &&
                  i.preventDefault()));
      ...
      (t.prototype._wheel = function (t) {
        ...
        var e = this.getIntersection(this.getPointerPosition());
        e && e.isListening()
          ? e._fireAndBubble(xt, { evt: t })
          : this._fire(xt, { evt: t, target: this, currentTarget: this }),
      ...
      (t.prototype._pointerdown = function (t) {
        if (O._pointerEventsEnabled) {
          this.setPointersPositions(t);
          var e =
            it(t.pointerId) || this.getIntersection(this.getPointerPosition());
      ...
      (t.prototype.setPointersPositions = function (t) {
        ...
        if (void 0 !== (t = t || window.event).touches) {
          if (
            ...
            a.prototype.each.call(t.touches, function (t) {
          ...
          (n = t.clientX - i.left),
            ...
            (this._pointerPositions = [
              { x: n, y: r, id: I._getFirstPointerId(t) },
            ]),
            (this._changedPointerPositions = [
              { x: n, y: r, id: I._getFirstPointerId(t) },
            ]);
      ...
      (t.prototype._buildDOM = function () {
        if (
          ...
          (this.bufferHitCanvas = new R({ pixelRatio: 1 })),
          O.isBrowser)
        ) {
  ...
  var Gt = (function (i) {
    function t(t) {
      ...
      return (
        ...
        e._checkVisibility(),
        e.on("imageSmoothingEnabledChange", e._checkSmooth),
        e._checkSmooth(),
        e
      );
    }
    return (
        ...
        return (
          ...
          this.index < t.getChildren().length - 1
            ? t.content.insertBefore(
                this.getCanvas()._canvas,
                t.getChildren()[this.index + 1].getCanvas()._canvas
              )
            : t.content.appendChild(this.getCanvas()._canvas),
          !0)
        );
      ...
      (t.prototype._toKonvaCanvas = function (t) {
        return (
          ...
          $.prototype._toKonvaCanvas.call(this, t)
        );
      }),
      (t.prototype._checkVisibility = function () {
        var t = this.visible();
  ...
  (Gt.prototype.nodeType = "BaseLayer"),
    b.addGetterSetter(Gt, "imageSmoothingEnabled", !0),
    b.addGetterSetter(Gt, "clearBeforeDraw", !0),
    a.mapMethods(Gt);
  var Rt,
    Lt = "hasShadow",
    Ot = "shadowRGBA",
  ...
  var Xt = (function (n) {
    function t(t) {
      for (
        var e, i = n.call(this, t) || this;
        !(e = I.getRandomColor()) || e in Bt;
    ...
    return (
      ...
      (t.prototype.drawScene = function (t, e, i, n) {
        ...
        if ((h.save(), this._useBufferCanvas(i) && !n)) {
          if (
            ((o = (r = this.getStage().bufferCanvas).getContext()).clear(),
            o.save(),
          ...
          c && p && !s.hitCanvas
            ? (h.save(),
              i ||
                (h._applyOpacity(this), h._applyGlobalCompositeOperation(this)),
              h._applyShadow(this),
              d.call(this, h, this),
              h.restore(),
              this.hasFill() &&
      ...
      (t.prototype.drawHitFromCache = function (t) {
        ...
        try {
          for (
            n = (i = (e = l.getImageData(0, 0, d, c)).data).length,
              r = I._hexToRgb(this.colorKey),
              o = 0;
            o < n;
            o += 4
          )
  ...
  (Xt.prototype._fillFunc = function (t) {
    ...
    i(Xt),
    b.addGetterSetter(Xt, "stroke", void 0, y()),
    b.addGetterSetter(Xt, "strokeWidth", 2, g()),
    b.addGetterSetter(Xt, "hitStrokeWidth", "auto", v()),
    b.addGetterSetter(Xt, "strokeHitEnabled", !0, m()),
    b.addGetterSetter(Xt, "perfectDrawEnabled", !0, m()),
    b.addGetterSetter(Xt, "shadowForStrokeEnabled", !0, m()),
    ...
    b.addGetterSetter(Xt, "dashOffset", 0, g()),
    b.addGetterSetter(Xt, "shadowColor", void 0, y()),
    b.addGetterSetter(Xt, "shadowBlur", 0, g()),
    b.addGetterSetter(Xt, "shadowOpacity", 1, g()),
    b.addComponentsGetterSetter(Xt, "shadowOffset", ["x", "y"]),
    b.addGetterSetter(Xt, "shadowOffsetX", 0, g()),
    b.addGetterSetter(Xt, "shadowOffsetY", 0, g()),
    b.addGetterSetter(Xt, "fillPatternImage"),
    b.addGetterSetter(Xt, "fill", void 0, y()),
    b.addGetterSetter(Xt, "fillPatternX", 0, g()),
    b.addGetterSetter(Xt, "fillPatternY", 0, g()),
    ...
    b.addGetterSetter(Xt, "fillPatternOffsetX", 0, g()),
    b.addGetterSetter(Xt, "fillPatternOffsetY", 0, g()),
    b.addComponentsGetterSetter(Xt, "fillPatternScale", ["x", "y"]),
    b.addGetterSetter(Xt, "fillPatternScaleX", 1, g()),
    b.addGetterSetter(Xt, "fillPatternScaleY", 1, g()),
  ...
  var jt = [
    ...
    qt = (function (n) {
      function t() {
        ...
        return (t.hitCanvas = new R({ pixelRatio: 1 })), t;
      }
      return (
        w(t, n),
        ...
        (t.prototype._validateAdd = function (t) {
          ...
          "Group" !== e &&
            "Shape" !== e &&
            I.throw("You may only add groups and shapes to a layer.");
        }),
        (t.prototype.getIntersection = function (t, e) {
          var i, n, r, o;
        ...
        (t.prototype._getIntersection = function (t) {
          var e,
            ...
            o = r[3];
          return 255 === o
            ? ((e = I._rgbToHex(r[0], r[1], r[2])),
              (i = Bt["#" + e]) ? { shape: i } : { antialiased: !0 })
            : 0 < o
            ? { antialiased: !0 }
            : {};
        }),
        (t.prototype.drawScene = function (t, e) {
          ...
          return (
            ...
            tt.prototype.drawScene.call(this, n, e),
        ...
        (t.prototype.drawHit = function (t, e) {
          ...
          return (
            ...
            tt.prototype.drawHit.call(this, n, e),
            this
          );
        }),
        (t.prototype.clear = function (t) {
          return (
            Gt.prototype.clear.call(this, t),
        ...
        (t.prototype.setSize = function (t) {
          var e = t.width,
            i = t.height;
          return (
            n.prototype.setSize.call(this, { width: e, height: i }),
  ...
  (qt.prototype.nodeType = "Layer"),
    i(qt),
    b.addGetterSetter(qt, "hitGraphEnabled", !0, m()),
    a.mapMethods(qt);
  var Vt = (function (t) {
    function e() {
      return (null !== t && t.apply(this, arguments)) || this;
    ...
    return (
      ...
      (e.prototype._validateAdd = function (t) {
        "Shape" !== t.getType() &&
          I.throw("You may only add shapes to a fast layer.");
      }),
      ...
      (e.prototype.drawScene = function (t) {
        ...
        return (
          ...
          tt.prototype.drawScene.call(this, i),
          this
        );
      }),
  ...
  var Kt = (function (t) {
    ...
    return (
      ...
      (e.prototype._validateAdd = function (t) {
        ...
        "Group" !== e &&
          "Shape" !== e &&
          I.throw("You may only add groups and shapes to groups.");
      }),
      e
    );
  })(tt);
  ...
  var Qt =
    ...
    Jt = (function () {
      ...
      return (
        (n.prototype.setLayers = function (t) {
          var e = [];
          return (
            (e = t ? (0 < t.length ? t : [t]) : []), (this.layers = e), this
          );
        }),
    ...
    Zt = { node: 1, duration: 1, easing: 1, onFinish: 1, yoyo: 1 },
    $t = 0,
    ...
    ie = (function () {
      function u(t) {
        ...
        this._addListeners(),
        u.attrs[o] || (u.attrs[o] = {}),
        u.attrs[o][this._id] || (u.attrs[o][this._id] = {}),
        u.tweens[o] || (u.tweens[o] = {}),
        t))
          void 0 === Zt[i] && this._addAttr(i, t[i]);
        this.reset(), (this.onFinish = t.onFinish), (this.onReset = t.onReset);
      }
      return (
        (u.prototype._addAttr = function (t, e) {
          var i,
            n,
            r,
            o,
            ...
            c = d._id;
          if (
            ((r = u.tweens[c][t]) && delete u.attrs[c][r][t],
            (i = d.getAttr(t)),
            I._isArray(e))
          )
            if (
              ((n = []),
              (a = Math.max(e.length, i.length)),
              "points" === t &&
                e.length !== i.length &&
                (e.length > i.length
                  ? ((h = i), (i = I._prepareArrayForTween(i, e, d.closed())))
                  : ((s = e), (e = I._prepareArrayForTween(e, i, d.closed())))),
              0 === t.indexOf("fill"))
            )
              for (o = 0; o < a; o++)
            ...
            else for (o = 0; o < a; o++) n.push(e[o] - i[o]);
          else
            n =
              -1 !== te.indexOf(t)
                ? ((i = I.colorToRGBA(i)),
        ...
        (u.prototype._tweenFunc = function (t) {
          ...
          for (e in d) {
            if (
              ((n = (i = d[e]).start), (r = i.diff), (h = i.end), I._isArray(n))
            )
              if (
                ((o = []),
              ...
              else for (a = 0; a < s; a++) o.push((n[a] || 0) + r[a] * t);
            else
              o =
                -1 !== te.indexOf(e)
                  ? "rgba(" +
  ...
  (oe.prototype._centroid = !0),
    (oe.prototype.className = "Arc"),
    (oe.prototype._attrsAffectingSize = ["innerRadius", "outerRadius"]),
    i(oe),
    b.addGetterSetter(oe, "innerRadius", 0, g()),
    b.addGetterSetter(oe, "outerRadius", 0, g()),
    b.addGetterSetter(oe, "angle", 0, g()),
    b.addGetterSetter(oe, "clockwise", !1, m()),
    a.mapMethods(oe);
  var ae = (function (i) {
    function t(t) {
      var e = i.call(this, t) || this;
    ...
    return (
      ...
      (t.prototype._getTensionPoints = function () {
        return this.closed()
          ...
          : I._expandPoints(this.points(), this.tension());
      }),
  ...
  (ae.prototype.className = "Line"),
    ...
    i(ae),
    b.addGetterSetter(ae, "closed", !1),
    b.addGetterSetter(ae, "bezier", !1),
    b.addGetterSetter(ae, "tension", 0, g()),
    b.addGetterSetter(
      ae,
      "points",
      [],
    ...
    return (
      ...
      (t.prototype._sceneFunc = function (t) {
        ...
        var o,
          ...
          s = i.length;
        a = r
          ? ((o = i[s - 2] - n[s - 2]), i[s - 1] - n[s - 1])
          : ((o = i[s - 2] - i[s - 4]), i[s - 1] - i[s - 3]);
  ...
  (se.prototype.className = "Arrow"),
    i(se),
    b.addGetterSetter(se, "pointerLength", 10, g()),
    b.addGetterSetter(se, "pointerWidth", 10, g()),
    b.addGetterSetter(se, "pointerAtBeginning", !1),
    a.mapMethods(se);
  var he = (function (t) {
    function e() {
      return (null !== t && t.apply(this, arguments)) || this;
  ...
  (he.prototype._centroid = !0),
    (he.prototype.className = "Circle"),
    (he.prototype._attrsAffectingSize = ["radius"]),
    i(he),
    b.addGetterSetter(he, "radius", 0, g()),
    a.mapMethods(he);
  var le = (function (t) {
    function e() {
      return (null !== t && t.apply(this, arguments)) || this;
  ...
  (le.prototype.className = "Ellipse"),
    (le.prototype._centroid = !0),
    (le.prototype._attrsAffectingSize = ["radiusX", "radiusY"]),
    i(le),
    b.addComponentsGetterSetter(le, "radius", ["x", "y"]),
    b.addGetterSetter(le, "radiusX", 0, g()),
    b.addGetterSetter(le, "radiusY", 0, g()),
    a.mapMethods(le);
  var de = (function (t) {
    function n() {
      return (null !== t && t.apply(this, arguments)) || this;
  ...
  (de.prototype.className = "Image"),
    i(de),
    b.addGetterSetter(de, "image"),
    b.addComponentsGetterSetter(de, "crop", ["x", "y", "width", "height"]),
    b.addGetterSetter(de, "cropX", 0, g()),
    b.addGetterSetter(de, "cropY", 0, g()),
    b.addGetterSetter(de, "cropWidth", 0, g()),
    b.addGetterSetter(de, "cropHeight", 0, g()),
    a.mapMethods(de);
  var ce = [
      "fontFamily",
      "fontSize",
      ...
      (e.prototype._sceneFunc = function (t) {
        ...
        t.beginPath(),
          ...
          "up" === n &&
            ...
            t.lineTo((e + r) / 2, 0)),
          a
            ? (t.lineTo(e - a, 0), t.arc(e - a, a, a, (3 * Math.PI) / 2, 0, !1))
            : t.lineTo(e, 0),
          n === pe &&
            (t.lineTo(e, (i - o) / 2),
            t.lineTo(e + r, i / 2),
            t.lineTo(e, (i + o) / 2)),
          a
            ? (t.lineTo(e, i - a), t.arc(e - a, i - a, a, 0, Math.PI / 2, !1))
            : t.lineTo(e, i),
          n === ue &&
            (t.lineTo((e + r) / 2, i),
            t.lineTo(e / 2, i + o),
            t.lineTo((e - r) / 2, i)),
          a
            ? (t.lineTo(a, i), t.arc(a, i - a, a, Math.PI / 2, Math.PI, !1))
            : t.lineTo(0, i),
          n === fe &&
            (t.lineTo(0, (i + o) / 2),
            t.lineTo(-1 * r, i / 2),
            t.lineTo(0, (i - o) / 2)),
          a && (t.lineTo(0, a), t.arc(a, a, a, Math.PI, (3 * Math.PI) / 2, !1)),
          t.closePath(),
          t.fillStrokeShape(this);
      }),
  ...
  (ye.prototype.className = "Tag"),
    i(ye),
    b.addGetterSetter(ye, "pointerDirection", "none"),
    b.addGetterSetter(ye, "pointerWidth", 0, g()),
    b.addGetterSetter(ye, "pointerHeight", 0, g()),
    b.addGetterSetter(ye, "cornerRadius", 0, g()),
    a.mapMethods(ye);
  var me = (function (n) {
    function u(t) {
    ...
    return (
      ...
      (u.prototype.getSelfRect = function () {
        ...
        for (
          var t, i, n = e[0], r = e[0], o = e[1], a = e[1], s = 0;
          s < e.length / 2;
          s++
        )
          (t = e[2 * s]),
            (i = e[2 * s + 1]),
            isNaN(t) || ((n = Math.min(n, t)), (r = Math.max(r, t))),
            isNaN(i) || ((o = Math.min(o, i)), (a = Math.max(a, i)));
        return {
          x: Math.round(n),
          y: Math.round(o),
          width: Math.round(r - n),
      ...
      (u.prototype.getPointAtLength = function (t) {
        ...
        switch (r.command) {
          ...
          case "C":
            return u.getPointOnCubicBezier(
              t / r.pathLength,
              r.start.x,
              r.start.y,
              o[0],
          ...
          case "Q":
            return u.getPointOnQuadraticBezier(
              t / r.pathLength,
              r.start.x,
              r.start.y,
              o[0],
          ...
          case "A":
            ...
            return (
              (d += (c * t) / r.pathLength),
              u.getPointOnEllipticalArc(a, s, h, l, d, p)
            );
        }
        return null;
      }),
      ...
      (u.getPointOnLine = function (t, e, i, n, r, o, a) {
        ...
        var l,
          d = s * h;
        if (n === e) l = { x: o, y: a + d };
        else if ((a - i) / (o - e + 1e-8) == s) l = { x: o + h, y: a + d };
        else {
          var c,
            p,
            u = this.getLineLength(e, i, n, r);
          if (u < 1e-8) return;
      ...
      (u.parsePathData = function (t) {
        ...
        for (n = 1; n < o.length; n++) {
            ...
            switch (p) {
              ...
              case "S":
                (m = h),
                  ...
                  "C" === (y = a[a.length - 1]).command &&
                    ((m = h + (h - y.points[2])), (_ = l + (l - y.points[3]))),
              ...
              case "T":
                (m = h),
                  ...
                  "Q" === (y = a[a.length - 1]).command &&
                    ((m = h + (h - y.points[0])), (_ = l + (l - y.points[1]))),
                  (h = u.shift()),
                  (l = u.shift()),
                  (T = "Q"),
                  M.push(m, _, h, l);
              ...
              case "A":
                (S = u.shift()),
                  ...
                  (l = u.shift()),
                  (T = "A"),
                  (M = this.convertEndpointToCenterParameterization(
                    P,
                    k,
                    h,
                    l,
          ...
          ("z" !== p && "Z" !== p) ||
            a.push({ command: "z", points: [], start: void 0, pathLength: 0 });
        }
        return a;
      }),
      ...
      (u.convertEndpointToCenterParameterization = function (
        t,
        e,
        i,
        n,
  ...
  (me.prototype.className = "Path"),
    (me.prototype._attrsAffectingSize = ["data"]),
    i(me),
    b.addGetterSetter(me, "data"),
    a.mapMethods(me);
  var _e = (function (t) {
    function e() {
      return (null !== t && t.apply(this, arguments)) || this;
      ...
      (e.prototype._sceneFunc = function (t) {
        ...
        if ((t.beginPath(), e)) {
          var r = 0,
            ...
            s = 0;
          "number" == typeof e
            ? (r = o = a = s = Math.min(e, i / 2, n / 2))
            : ((r = Math.min(e[0], i / 2, n / 2)),
  ...
  (_e.prototype.className = "Rect"),
    i(_e),
    b.addGetterSetter(_e, "cornerRadius", 0),
    a.mapMethods(_e);
  var Se = (function (t) {
    function e() {
      return (null !== t && t.apply(this, arguments)) || this;
  ...
  (Se.prototype.className = "RegularPolygon"),
    ...
    i(Se),
    b.addGetterSetter(Se, "radius", 0, g()),
    b.addGetterSetter(Se, "sides", 0, g()),
    a.mapMethods(Se);
  var be = 2 * Math.PI,
    xe = (function (t) {
      function e() {
      ...
      return (
        ...
        (e.prototype._sceneFunc = function (t) {
          t.beginPath(),
            t.arc(0, 0, this.innerRadius(), 0, be, !1),
            t.moveTo(this.outerRadius(), 0),
            t.arc(0, 0, this.outerRadius(), be, 0, !0),
            t.closePath(),
            t.fillStrokeShape(this);
        }),
        (e.prototype.getWidth = function () {
  ...
  (xe.prototype.className = "Ring"),
    (xe.prototype._centroid = !0),
    (xe.prototype._attrsAffectingSize = ["innerRadius", "outerRadius"]),
    i(xe),
    b.addGetterSetter(xe, "innerRadius", 0, g()),
    b.addGetterSetter(xe, "outerRadius", 0, g()),
    a.mapMethods(xe);
  var we = (function (i) {
    function t(t) {
      var e = i.call(this, t) || this;
  ...
  (we.prototype.className = "Sprite"),
    i(we),
    b.addGetterSetter(we, "animation"),
    b.addGetterSetter(we, "animations"),
    b.addGetterSetter(we, "frameOffsets"),
    b.addGetterSetter(we, "image"),
    b.addGetterSetter(we, "frameIndex", 0, g()),
    b.addGetterSetter(we, "frameRate", 17, g()),
    b.backCompat(we, {
      index: "frameIndex",
  ...
  (Ce.prototype.className = "Star"),
    (Ce.prototype._centroid = !0),
    (Ce.prototype._attrsAffectingSize = ["innerRadius", "outerRadius"]),
    i(Ce),
    b.addGetterSetter(Ce, "numPoints", 5, g()),
    b.addGetterSetter(Ce, "innerRadius", 0, g()),
    b.addGetterSetter(Ce, "outerRadius", 0, g()),
    a.mapMethods(Ce);
  var Pe,
    ke = "auto",
    Te = "justify",
  ...
  var Re = (function (n) {
    function t(t) {
      ...
      e._partialTextX = 0;
      for (var i = (e._partialTextY = 0); i < Ae; i++)
        e.on(Me[i] + "Change.konva", e._setTextData);
    ...
    return (
        ...
        for (
          t.setAttr("font", this._getContextFont()),
            ...
            "middle" === s
              ...
              : "bottom" === s && (h = this.getHeight() - a * r - 2 * i),
            t.translate(i, h + i),
            e = 0;
          e < a;
          e++
          ...
          if (
            ...
            for (var k = 0; k < w.length; k++) {
              ...
              " " === T &&
                e !== a - 1 &&
                l === Te &&
                (y += Math.floor((d - 2 * i - C) / _)),
                (this._partialTextX = y),
                (this._partialTextY = v + m),
                (this._partialText = T),
                t.fillStrokeShape(this),
                (y += Math.round(this.measureSize(T).width) + c);
            }
          } else
            (this._partialTextX = y),
              (this._partialTextY = v + m),
      ...
      (t.prototype.getWidth = function () {
        return this.attrs.width === ke || void 0 === this.attrs.width
          ? this.getTextWidth() + 2 * this.padding()
          : this.attrs.width;
      }),
      (t.prototype.getHeight = function () {
        return this.attrs.height === ke || void 0 === this.attrs.height
      ...
      (t.prototype._setTextData = function () {
        ...
        for (
          var v = g ? this._getTextWidth("…") : 0, y = 0, m = t.length;
          y < m;
          ++y
        ) {
          var _ = t[y],
              ...
              if (f) {
                ...
                0 <
                  (M =
                    (" " === A || "-" === A) && C <= l
                      ? w.length
                      : Math.max(w.lastIndexOf(" "), w.lastIndexOf("-")) + 1) &&
                  ((b = M), (w = w.slice(0, b)), (C = this._getTextWidth(w)));
              }
              if (
                ((w = w.trimRight()),
                this._addTextLine(w),
                ...
                break;
              if (
                0 < (_ = (_ = _.slice(b)).trimLeft()).length &&
                (S = this._getTextWidth(_)) <= l
              ) {
  ...
  (Re.prototype._fillFunc = function (t) {
    ...
    i(Re),
    b.overWriteSetter(Re, "width", v()),
    b.overWriteSetter(Re, "height", v()),
    b.addGetterSetter(Re, "fontFamily", "Arial"),
    b.addGetterSetter(Re, "fontSize", 12, g()),
    b.addGetterSetter(Re, "fontStyle", "normal"),
    b.addGetterSetter(Re, "fontVariant", "normal"),
    b.addGetterSetter(Re, "padding", 0, g()),
    b.addGetterSetter(Re, "align", "left"),
    b.addGetterSetter(Re, "verticalAlign", "top"),
    b.addGetterSetter(Re, "lineHeight", 1, g()),
    b.addGetterSetter(Re, "wrap", "word"),
    b.addGetterSetter(Re, "ellipsis", !1),
    b.addGetterSetter(Re, "letterSpacing", 0, g()),
    b.addGetterSetter(Re, "text", "", y()),
    b.addGetterSetter(Re, "textDecoration", ""),
    a.mapMethods(Re);
  function Le(t) {
  ...
  var Ie = (function (i) {
    function t(t) {
      var e = i.call(this, t) || this;
      return (
        (e.dummyCanvas = I.createCanvasElement()),
        (e.dataArray = []),
        (e.dataArray = me.parsePathData(e.attrs.data)),
        e.on("dataChange.konva", function () {
          (this.dataArray = me.parsePathData(this.attrs.data)),
            this._setTextData();
        }),
        e.on(
    ...
    return (
      ...
      (t.prototype._sceneFunc = function (t) {
        ...
        for (var o = 0; o < r.length; o++) {
          ...
          t.translate(a.x, a.y),
            ...
            t.fillStrokeShape(this),
            "underline" === e &&
              (0 === o && t.moveTo(0, n / 2 + 1), t.lineTo(n, n / 2 + 1)),
            t.restore();
        }
        "underline" === e &&
      ...
      (t.prototype._setTextData = function () {
        ...
        var p = Math.max(
          this.textWidth + ((this.attrs.text || "").length - 1) * d,
          0
        );
        this.glyphInfo = [];
        ...
        var n = 0;
        "center" === c && (n = Math.max(0, u / 2 - p / 2)),
          "right" === c && (n = Math.max(0, u - p));
        for (
          var f,
            g,
            v,
            ...
            a = function (t) {
              ...
              var i = 0,
                n = 0;
              for (g = void 0; 0.01 < Math.abs(e - i) / e && n < 25; ) {
                n++;
                ...
                switch (v.command) {
                  case "L":
                    me.getLineLength(f.x, f.y, v.points[0], v.points[1]) > e
                      ? (g = me.getPointOnLine(
                          e,
                          f.x,
                          f.y,
                  ...
                  case "C":
                    0 === m
                      ? (m = e > v.pathLength ? 1e-8 : e / v.pathLength)
                      : i < e
                      ? (m += (e - i) / v.pathLength)
                      : (m -= (i - e) / v.pathLength),
                      1 < m && ((m = 1), (o = !0)),
                      (g = me.getPointOnCubicBezier(
                        m,
                        v.start.x,
                        v.start.y,
                        v.points[0],
                  ...
                  case "Q":
                    0 === m
                      ...
                      : (m -= (i - e) / v.pathLength),
                      1 < m && ((m = 1), (o = !0)),
                      (g = me.getPointOnQuadraticBezier(
                        m,
                        v.start.x,
                        v.start.y,
                        v.points[0],
                ...
                void 0 !== g && (i = me.getLineLength(f.x, f.y, g.x, g.y)),
                  o && ((o = !1), (v = void 0));
              }
            },
            s = l._getTextSize("C").width + d,
            h = 0;
          h < n / s && (a("C"), void 0 !== f && void 0 !== g);
          h++
        )
          f = g;
        for (
          var S = 0;
          S < r.length && (a(r[S]), void 0 !== f && void 0 !== g);
          S++
        ) {
      ...
      (t.prototype.getSelfRect = function () {
        ...
        for (
          var t, i, n = e[0], r = e[0], o = e[0], a = e[0], s = 0;
          s < e.length / 2;
          s++
        )
          (t = e[2 * s]),
  ...
  (Ie.prototype._fillFunc = Le),
    (Ie.prototype._strokeFunc = Oe),
    (Ie.prototype._fillFuncHit = Le),
    (Ie.prototype._strokeFuncHit = Oe),
    (Ie.prototype.className = "TextPath"),
    (Ie.prototype._attrsAffectingSize = ["text", "fontSize", "data"]),
    i(Ie),
    b.addGetterSetter(Ie, "data"),
    b.addGetterSetter(Ie, "fontFamily", "Arial"),
    b.addGetterSetter(Ie, "fontSize", 12, g()),
    b.addGetterSetter(Ie, "fontStyle", "normal"),
    b.addGetterSetter(Ie, "align", "left"),
    b.addGetterSetter(Ie, "letterSpacing", 0, g()),
    b.addGetterSetter(Ie, "textBaseline", "middle"),
    b.addGetterSetter(Ie, "fontVariant", "normal"),
    b.addGetterSetter(Ie, "text", ""),
    b.addGetterSetter(Ie, "textDecoration", null),
    b.addGetterSetter(Ie, "kerningFunc", null),
    a.mapMethods(Ie);
  var De = [
      "resizeEnabledChange",
    ...
    We = (function (i) {
      ...
      return (
        ...
        (t.prototype.detach = function () {
          this.getNode() && (this.getNode().off(".tr"), (this._node = void 0)),
            this._resetTransformCache();
        }),
        ...
        (t.prototype.__getNodeRect = function () {
          var t = this.getNode();
          if (!t) return { x: -1e8, y: -1e8, width: 0, height: 0, rotation: 0 };
          t.parent &&
            this.parent &&
        ...
        (t.prototype._createAnchor = function (r) {
          ...
          a.on("mousedown touchstart", function (t) {
            ...
            a.on("mouseenter", function () {
              var t = O.getAngle(o.rotation()),
                ...
                n = (function (t, e, i) {
                  ...
                  return I._inRange(n, 337.5, 360) || I._inRange(n, 0, 22.5)
                    ? "ns-resize"
                    : I._inRange(n, 22.5, 67.5)
                    ? "nesw-resize"
                    : I._inRange(n, 67.5, 112.5)
                    ? "ew-resize"
                    : I._inRange(n, 112.5, 157.5)
                    ? "nwse-resize"
                    : I._inRange(n, 157.5, 202.5)
                    ? "ns-resize"
                    : I._inRange(n, 202.5, 247.5)
                    ? "nesw-resize"
                    : I._inRange(n, 247.5, 292.5)
                    ? "ew-resize"
                    : I._inRange(n, 292.5, 337.5)
                    ? "nwse-resize"
                    : (I.error(
            ...
            a.on("mouseout", function () {
              a.getStage() &&
                a.getParent() &&
                ((a.getStage().content.style.cursor = ""),
                (o._cursorChange = !1));
            }),
            this.add(a);
        }),
            ...
            sceneFunc: function (t) {
              ...
              t.beginPath(),
                ...
                e.rotateEnabled() &&
                  t.lineTo(
                    this.width() / 2,
                    -e.rotateAnchorOffset() * I._sign(this.height())
                  ),
                t.fillStrokeShape(this);
            },
          });
        ...
        (t.prototype._handleMouseMove = function (t) {
          var e,
            i,
            n,
            r = this.findOne("." + this.movingResizer),
          ...
          if ("top-left" === this.movingResizer) {
            if (l) {
              n = Math.sqrt(
                Math.pow(this.findOne(".bottom-right").x() - r.x(), 2) +
                  Math.pow(this.findOne(".bottom-right").y() - r.y(), 2)
              );
              var d =
            ...
            if (l) {
              n = Math.sqrt(
                Math.pow(this.findOne(".bottom-left").x() - r.x(), 2) +
                  Math.pow(this.findOne(".bottom-left").y() - r.y(), 2)
              );
              d =
            ...
            if (l) {
              n = Math.sqrt(
                Math.pow(this.findOne(".top-right").x() - r.x(), 2) +
                  Math.pow(this.findOne(".top-right").y() - r.y(), 2)
              );
              d =
            ...
            for (
              var g = O.getAngle(this.rotation()),
                v = I._radToDeg(g) + I._radToDeg(f),
                y = O.getAngle(this.getNode().rotation()),
                m = I._degToRad(v),
              ...
              Math.abs(b - I._degToRad(v)) % (2 * Math.PI) < 0.1 &&
                ((v = I._radToDeg(b)), (m = I._degToRad(v)));
            }
            var x = p,
              w = p;
            this._fitNodeInto(
              {
                ...
                x:
                  u.x +
                  (u.width / 2 + p) * (Math.cos(y) - Math.cos(m)) +
                  (u.height / 2 + p) * (Math.sin(-y) - Math.sin(-m)) -
                  (x * Math.cos(g) + w * Math.sin(-g)),
                y:
                  u.y +
                  (u.height / 2 + p) * (Math.cos(y) - Math.cos(m)) +
                  (u.width / 2 + p) * (Math.sin(y) - Math.sin(m)) -
                  (w * Math.cos(g) + x * Math.sin(g)),
                width: u.width + 2 * p,
                height: u.height + 2 * p,
              },
              t
  ...
  (We.prototype.className = "Transformer"),
    i(We),
    b.addGetterSetter(We, "enabledAnchors", ze, function (t) {
      return (
        t instanceof Array || I.warn("enabledAnchors value should be an array"),
        t instanceof Array &&
          t.forEach(function (t) {
            -1 === ze.indexOf(t) &&
              I.warn(
    ...
    b.addGetterSetter(We, "resizeEnabled", !0),
    b.addGetterSetter(We, "anchorSize", 10, g()),
    b.addGetterSetter(We, "rotateEnabled", !0),
    b.addGetterSetter(We, "rotationSnaps", []),
    b.addGetterSetter(We, "rotateAnchorOffset", 50, g()),
    b.addGetterSetter(We, "borderEnabled", !0),
    b.addGetterSetter(We, "anchorStroke", "rgb(0, 161, 255)"),
    b.addGetterSetter(We, "anchorStrokeWidth", 1, g()),
    b.addGetterSetter(We, "anchorFill", "white"),
    b.addGetterSetter(We, "anchorCornerRadius", 0, g()),
    b.addGetterSetter(We, "borderStroke", "rgb(0, 161, 255)"),
    b.addGetterSetter(We, "borderStrokeWidth", 1, g()),
    b.addGetterSetter(We, "borderDash"),
    b.addGetterSetter(We, "keepRatio", !0),
    b.addGetterSetter(We, "centeredScaling", !1),
    b.addGetterSetter(We, "ignoreStroke", !1),
    b.addGetterSetter(We, "padding", 0, g()),
    b.addGetterSetter(We, "node"),
  ...
  (Ne.prototype.className = "Wedge"),
    ...
    i(Ne),
    b.addGetterSetter(Ne, "radius", 0, g()),
    b.addGetterSetter(Ne, "angle", 0, g()),
    b.addGetterSetter(Ne, "clockwise", !1),
    b.backCompat(Ne, {
      angleDeg: "angle",
  ...
  b.addGetterSetter($, "embossStrength", 0.5, g(), b.afterSetFilter),
    b.addGetterSetter($, "embossWhiteLevel", 0.5, g(), b.afterSetFilter),
    b.addGetterSetter($, "embossDirection", "top-left", null, b.afterSetFilter),
    b.addGetterSetter($, "embossBlend", !1, null, b.afterSetFilter);
  b.addGetterSetter($, "enhance", 0, g(), b.afterSetFilter);
  b.addGetterSetter($, "hue", 0, g(), b.afterSetFilter),
    b.addGetterSetter($, "saturation", 0, g(), b.afterSetFilter),
    b.addGetterSetter($, "luminance", 0, g(), b.afterSetFilter);
  b.addGetterSetter($, "hue", 0, g(), b.afterSetFilter),
    b.addGetterSetter($, "saturation", 0, g(), b.afterSetFilter),
    b.addGetterSetter($, "value", 0, g(), b.afterSetFilter);
  function Ue(t, e, i) {
    var n = 4 * (i * t.width + e),
      r = [];
  ...
  b.addGetterSetter($, "kaleidoscopePower", 2, g(), b.afterSetFilter),
    b.addGetterSetter($, "kaleidoscopeAngle", 0, g(), b.afterSetFilter);
  b.addGetterSetter($, "threshold", 0, g(), b.afterSetFilter);
  b.addGetterSetter($, "noise", 0.2, g(), b.afterSetFilter);
  b.addGetterSetter($, "pixelSize", 8, g(), b.afterSetFilter);
  b.addGetterSetter($, "levels", 0.5, g(), b.afterSetFilter);
  b.addGetterSetter($, "red", 0, function (t) {
    return (
      (this._filterUpToDate = !1), 255 < t ? 255 : t < 0 ? 0 : Math.round(t)
    );
  }),
  ...
  b.addGetterSetter($, "red", 0, function (t) {
    ...
    b.addGetterSetter($, "blue", 0, f, b.afterSetFilter),
    b.addGetterSetter($, "alpha", 1, function (t) {
      return (this._filterUpToDate = !1), 1 < t ? 1 : t < 0 ? 0 : t;
    });
  return (
    b.addGetterSetter($, "threshold", 0.5, g(), b.afterSetFilter),
    re.Util._assign(re, {
      Arc: oe,
      Arrow: se,
      Circle: he,
      ...
      Filters: {
            ...
            (function (t, e) {
              ...
              for (E.next = I, h = s = 0, n = 0; n < M; n++) {
                for (
                  ...
                  (E.r = b), (E.g = x), (E.b = w), (E.a = C), (E = E.next);
                for (r = 1; r < L; r++)
                  (o = s + ((G < r ? G : r) << 2)),
                    (l += (E.r = b = k[o]) * (P = L - r)),
                    (d += (E.g = x = k[o + 1]) * P),
            ...
            do {
              ...
              if (
                ...
                (s[v] = 255 < C ? 255 : C < 0 ? 0 : C),
                  (s[1 + v] = 255 < P ? 255 : P < 0 ? 0 : P),
                  (s[2 + v] = 255 < k ? 255 : k < 0 ? 0 : k);
              } else {
                var T = i - x;
                T < 0 ? (T = 0) : 255 < T && (T = 255),
                  (s[v] = s[1 + v] = s[2 + v] = T);
        ...
        Enhance: function (t) {
          ...
          if (0 !== u) {
            for (r = 0; r < a; r += 4)
              (e = o[r + 0]) < s ? (s = e) : h < e && (h = e),
                (i = o[r + 1]) < l ? (l = i) : d < i && (d = i),
                (n = o[r + 2]) < c ? (c = n) : p < n && (p = n);
            ...
            for (
              ...
              (o[r + 0] = je(o[r + 0], s, h, v, g)),
                (o[r + 1] = je(o[r + 1], l, d, _, m)),
                (o[r + 2] = je(o[r + 2], c, p, x, b));
          }
        },
        Grayscale: function (t) {
          var e,
            ...
            r = n.length;
          for (e = 0; e < r; e += 4)
            (i = 0.34 * n[e] + 0.5 * n[e + 1] + 0.16 * n[e + 2]),
              (n[e] = i),
              (n[e + 1] = i),
              (n[e + 2] = i);
        },
        HSL: function (t) {
          var e,
            ...
            u = 0.299 + 0.701 * c + 0.167 * p,
            f = 0.587 - 0.587 * c + 0.33 * p,
            g = 0.114 - 0.114 * c - 0.497 * p,
            v = 0.299 - 0.299 * c - 0.328 * p,
            y = 0.587 + 0.413 * c + 0.035 * p,
            m = 0.114 - 0.114 * c + 0.293 * p,
            _ = 0.299 - 0.3 * c + 1.25 * p,
            S = 0.587 - 0.586 * c - 1.05 * p,
            b = 0.114 + 0.886 * c - 0.2 * p;
          for (e = 0; e < s; e += 4)
            (i = a[e + 0]),
              (n = a[e + 1]),
              (r = a[e + 2]),
        ...
        HSV: function (t) {
          var e,
            ...
            u = 0.299 * h + 0.701 * c + 0.167 * p,
            f = 0.587 * h - 0.587 * c + 0.33 * p,
            g = 0.114 * h - 0.114 * c - 0.497 * p,
            v = 0.299 * h - 0.299 * c - 0.328 * p,
            y = 0.587 * h + 0.413 * c + 0.035 * p,
            m = 0.114 * h - 0.114 * c + 0.293 * p,
            _ = 0.299 * h - 0.3 * c + 1.25 * p,
            S = 0.587 * h - 0.586 * c - 1.05 * p,
            b = 0.114 * h + 0.886 * c - 0.2 * p;
          for (e = 0; e < s; e += 4)
            (i = a[e + 0]),
              (n = a[e + 1]),
              (r = a[e + 2]),
        ...
        Kaleidoscope: function (t) {
          ...
          if (!(p < 1)) {
            ...
            !(function (t, e, i) {
              ...
              for (_ = 0; _ < w; _ += 1)
                for (
                  S = Math.sin(_ * C), b = Math.cos(_ * C), m = 0;
                  m < x;
                  m += 1
                )
                  (r = Math.floor(c + ((y * m) / x) * b)),
                    (u =
                      s[
                        0 +
                          (n =
                            4 *
                            ((o = Math.floor(p + ((y * m) / x) * S)) * l + r))
                      ]),
                    (f = s[n + 1]),
                    (g = s[n + 2]),
                    (v = s[n + 3]),
                    ...
                    (h[n + 2] = g),
                    (h[n + 3] = v);
            })(t, v, { polarCenterX: d / 2, polarCenterY: c / 2 });
            ...
            var m = (y = Math.ceil(y)),
              ...
              b = 1;
            for (
              d < f + y && ((_ = m), (S = 0), (b = -1)), i = 0;
              i < c;
              i += 1
            )
              for (e = _; e !== S; e += b)
                (h = 4 * (d * i + (Math.round(e + f) % d))),
                  (r = v.data[h + 0]),
                  (o = v.data[h + 1]),
                  (a = v.data[h + 2]),
                  (s = v.data[h + 3]),
              ...
              for (r = 0; r < c; r += 1)
                for (o = 0; o < p; o += 1)
                  (a = r - u),
                    ...
                    (b =
                      ((b =
                        ((180 * Math.atan2(s, a)) / Math.PI + 360 + P) % 360) *
                        C) /
                      360),
                    (x = Math.floor(b)),
                    (g = l[0 + (n = 4 * (Math.floor(S) * c + x))]),
                    (v = l[n + 1]),
                    (y = l[n + 2]),
                    (m = l[n + 3]),
                    (d[0 + (n = 4 * (o * c + r))] = g),
        ...
        Sepia: function (t) {
          ...
          for (e = 0; e < a; e += 4)
            (i = o[e + 0]),
              (n = o[e + 1]),
              (r = o[e + 2]),
              (o[e + 0] = Math.min(255, 0.393 * i + 0.769 * n + 0.189 * r)),
              (o[e + 1] = Math.min(255, 0.349 * i + 0.686 * n + 0.168 * r)),
              (o[e + 2] = Math.min(255, 0.272 * i + 0.534 * n + 0.131 * r));
        },
        Solarize: function (t) {
          var e = t.data,
            i = t.width,
